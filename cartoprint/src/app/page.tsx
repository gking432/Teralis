...
export default function StorefrontPage() {
  return (
    <main className="studio-topography min-h-screen overflow-hidden bg-[#14201d] text-[#f7f4eb]">
      <StudioHeader />
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-70px)] max-w-[1500px] grid-cols-1 items-center gap-12 px-6 py-12 md:px-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(440px,1.08fr)] lg:gap-20 lg:px-16 lg:py-14">
        ...
        <div className="relative z-10 max-w-2xl">
          <div className="studio-kicker">Detailed city map prints</div>
          ...
          <p className="mt-9 max-w-xl text-[15px] font-light leading-7 text-[#dce2dd]/68 md:text-[17px]">
            Search for any city or town. We draw the complete street network, then you choose the detail, color, labels, and print.
          </p>

          <div className="mt-9 max-w-2xl">
            <LocationSearch placeholder="Search for your city or town" />
