...
const V1_PALETTES: Palette[] = [
  {
    id: 'charcoal',
    name: 'Charcoal',
    blurb: 'Graphite water, soft streets',
    colors: { land: PAPER_WHITE, water: '#242a2f', roads: '#8d949b' },
  ...
  },
  {
    id: 'navy',
    name: 'Blue',
    blurb: 'Deep navy water, soft blue streets',
    colors: { land: PAPER_WHITE, water: '#12365e', roads: '#8aa4bb' },
  ...
  },
  {
    id: 'crimson',
    name: 'Red',
    blurb: 'Crimson water, soft red streets',
    colors: { land: PAPER_WHITE, water: '#a52a1f', roads: '#bd8f85' },
  ...
  },
  {
    id: 'forest-green',
    name: 'Green',
    blurb: 'Forest water, soft green streets',
    colors: { land: PAPER_WHITE, water: '#1d4d38', roads: '#86a396' },
  ...
  },
  {
    id: 'ochre-gold',
    name: 'Yellow',
    blurb: 'Ochre water, soft gold streets',
    colors: { land: PAPER_WHITE, water: '#8a6410', roads: '#b3a173' },
...
export const PALETTES: Palette[] = [
  ...
  },
  {
    ...
    colors: { land: '#f4f0e7', water: '#4b433a', roads: '#617784' },
  ...
  },
  {
    id: 'slate',
    name: 'Slate',
    blurb: 'Dark water, soft slate streets',
    colors: { land: PAPER_WHITE, water: '#3f4b57', roads: '#7d8994' },
